...
function Window({ children, name }) {
  ...
  return createPortal(
    <div>
      <div className="fixed top-0 left-0 z-[110] h-full w-full bg-[#00000050] backdrop-blur-sm" />
      <div className="fixed top-0 left-0 z-[10000000] h-full w-full">
        <div className="bg-main fixed top-[50%] left-[50%] z-50 max-h-[80vh] w-[90%] translate-x-[-50%] translate-y-[-50%] rounded-lg shadow-md md:w-[750px]">
          <button
            aria-label="Close"
            title="Close"
            onClick={close}
