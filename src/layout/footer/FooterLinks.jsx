      ...
      <div className="mt-2 flex w-full flex-col gap-1.5">
        {links.map(({ path, text, icon: Icon }) => (
          <button
            ...
            className="hover:text-primary text-light flex w-full cursor-pointer items-center justify-center gap-1.5 transition-all hover:ps-1 hover:font-semibold sm:justify-start"
          >
            <Icon />
            <span>{text}</span>
          </button>
