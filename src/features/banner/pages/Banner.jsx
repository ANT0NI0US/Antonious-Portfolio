    ...
    >
      <div className="container flex flex-col-reverse items-center justify-between gap-4 lg:flex-row">
        ...
        <div className="flex w-full items-center justify-center lg:basis-3/5 lg:justify-end">
          <div
            className="before:max-w-[250px] sm:before:max-w-[400px] lg:relative lg:z-0 lg:ml-20 lg:before:absolute lg:before:-left-12 lg:before:top-2
          ...
          >
            <img
              className="w-full max-w-[250px] rounded-full transition duration-500 hover:grayscale hover:filter sm:max-w-[400px] lg:max-w-[450px] 2xl:max-w-[600px]"
              src={profile}
              alt="profile"
            />
          </div>
